...
The system is evidenced rather than asserted: **1541 tests**, a mechanically
enforced 150-line ceiling on every one of the **341** tracked Python files, and
...
| Discipline | State |
|---|---|
| Test suite | **1541 tests**, all passing (unit → live two-process HTTP) |
| Line limit | every one of the **341** tracked Python files ≤ **150 lines** (max: 150) |
